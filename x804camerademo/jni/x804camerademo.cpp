...
//#define A23
extern "C" {
	JNIEXPORT jstring  JNICALL  Java_com_bsk_x804camerademo_MainActivity_setValue(JNIEnv * env, jobject obj,jstring port,jint num ,jint value);
	JNIEXPORT jint  JNICALL  Java_com_bsk_x804camerademo_MainActivity_getValue(JNIEnv * env, jobject obj,jstring port,jint num);
	JNIEXPORT jstring  JNICALL  Java_com_bsk_x804camerademo_MainActivity_setDirection(JNIEnv * env, jobject obj, jstring port,jint num,jstring inout);
