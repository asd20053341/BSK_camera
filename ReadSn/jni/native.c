 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_bsk_jni_Readsn_readsn_initReadsn
 ...
 */
JNIEXPORT jstring JNICALL Java_com_bsk_jni_Readsn_readsn_readsn
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_bsk_jni_Readsn_readsn_stopSn
  (JNIEnv *env, jclass thiz){
	LOGD("release");
	free(pri_buf);
}
