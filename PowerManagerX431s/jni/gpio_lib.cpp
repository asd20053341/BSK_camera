...
//#define A23
extern "C" {
	JNIEXPORT jstring  JNICALL  Java_com_bsk_powermanager_x431s_MyServiceX431s_setValue(JNIEnv * env, jobject obj,jstring port,jint num ,jint value);
	JNIEXPORT jint  JNICALL  Java_com_example_gpio1_MainActivity_getValue(JNIEnv * env, jobject obj,jstring port,jint num);
	JNIEXPORT jstring  JNICALL  Java_com_bsk_powermanager_x431s_MyServiceX431s_setDirection(JNIEnv * env, jobject obj, jstring port,jint num,jstring inout);
